...
check.dynamic_void: dynamically allocates data then passes the address of the allocation to a byte assignment function, which assigns the last value of the allocation using that address.<br>
stringcheck: a little checklist program that assigns void bytes to create a contiguous pointer of substrings.
